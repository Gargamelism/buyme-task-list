...
define("tasks-fe/templates/components/tasks-header", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "b9J2bcku", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"tasks-header\"],[7],[0,\"\\n  \"],[6,\"h2\"],[7],[0,\"משימות\"],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"add-task\"],[7],[6,\"strong\"],[7],[0,\"+\"],[8],[8],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "tasks-fe/templates/components/tasks-header.hbs" } });
});
define("tasks-fe/templates/index", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "H7EftA8Q", "block": "{\"symbols\":[],\"statements\":[[1,[18,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "tasks-fe/templates/index.hbs" } });
});
define("tasks-fe/templates/tasks", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "kTptnwGh", "block": "{\"symbols\":[\"task\"],\"statements\":[[6,\"div\"],[9,\"class\",\"container\"],[7],[0,\"\\n  \"],[1,[18,\"tasks-header\"],false],[0,\"\\n\"],[4,\"each\",[[20,[\"model\"]]],null,{\"statements\":[[0,\"    \"],[6,\"task\"],[9,\"class\",\"task\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"mark-completed\"],[7],[8],[0,\"\\n      \"],[6,\"h3\"],[7],[1,[19,1,[\"title\"]],false],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"delete-task\"],[7],[8],[0,\"\\n    \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[8]],\"hasEval\":false}", "meta": { "moduleName": "tasks-fe/templates/tasks.hbs" } });
});
...
if (!runningTests) {
  require("tasks-fe/app")["default"].create({"name":"tasks-fe","version":"0.0.0+dfec2e45"});
}
